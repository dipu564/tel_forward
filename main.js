...
const ownerUserId = process.env.OWNER; // Replace with your user ID
const authorizedUsers = {process.env.OWNER}; // Object to store authorized user IDs and their data
